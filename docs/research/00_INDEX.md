...
| [04_ltc_domain.md](04_ltc_domain.md) | LTC pharmacy substitution domain | 800 | **The decisive reframing: caregivers don't substitute. The product is an EXPLAINER for bottle-vs-MAR reconciliation, not an advisor.** DAW codes documented; FrameworkLTC ecosystem mapped. |
